...
// Chama animação ao carregar a pag
...
// Fáz a animação ao carregar a pagina
const animation = () => {
  setTimeout(() => {
...
// Anima somente os elementos proncipais
const mainAnimation = () => {
  elementosAnimados.forEach((elemento) => {
...
const addToCart = (event) => {
  ...
  if (existingItem) {
    ...
    if (menuItem) {
      ...
      console.error('Item não encontrado para a chave:', key);
    }
  }
